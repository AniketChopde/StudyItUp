...
Error: strict mode violation: getByText('Profile') resolved to 3 elements:
    ...
    3) <button type="submit" class="justify-center text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background bg-primary text-primary-foreground hover:bg-primary/90 h-11 rounded-xl px-8 font-black tracking-wider uppercase shadow-xl shadow-primary/20 flex items-center gap-2">…</button> aka getByRole('button', { name: 'Save Profile' })
